...
if __name__ == '__main__':
    ...
    hyperparams1 = (0.5, 120.0, -64.0, -64.0, 19.0)
    hyperparams2 = (0.4, 0.0, -78.667, -80.0, 40.0)
    ...
    # 2. Then, we will run multiple, single and short simulations, where each simulation contains a different random initialization
    
    # Initial conditions to be chosen at random, in a certain range. See that they induce transient states.
    n_inconds = 50
