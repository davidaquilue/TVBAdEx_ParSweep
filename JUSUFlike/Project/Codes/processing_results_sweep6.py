"""SAME EXACT FILE AS processing_results.py but without rounding the parameter values! Done to analyze the results of
the preliminary run by Sandra Diaz with 6 values/parameter.
...
if __name__ == '__main__':
    ...
    if '1' in do_these:
        ...
        for n_chunk in chunks_to_process:
            indicator_folder = '../../Scratch/Indicators/chunk_' + str(n_chunk) + '/'
            results_folder = '../../Scratch/Results/chunk_' + str(n_chunk) + '/'
    ...
    if '2' in do_these:
        n_chunks = len(os.listdir('../../Scratch/Results/'))
